...
Bug Fix Template is a Chrome extension that  "enhances your productivity by providing quick access to templates" 
...
Usage
Once installed, you will see the extension icon in your Chrome toolbar. Click it to:

Select from predefined bug-fix templates

Quickly apply standardized formats to your comments or notes
